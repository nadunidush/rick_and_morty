...
class EpisodeHorizontalCard extends StatelessWidget {
  ...
  const EpisodeHorizontalCard({super.key, required this.episode, required this.index});
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            ...
            Positioned.fill(
              child: episode.imageUrl != null
                  ...
                  : Container(
                      color: Colors.grey[800],
                      child: const Center(
                        child: Icon(Icons.tv, color: Colors.white54, size: 50),
                      ),
                    ),
            ),
            ...
            // Episode Name (top left, semi-transparent background)
            Positioned(
              top: 0,
              left: 0,
              right: 0,
